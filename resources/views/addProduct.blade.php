                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action='addProduct' method="POST">
                            ...
                            <input type = "text" name="image" placeholder="Enter Product Image Url" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; font-size: 16px; width: 100%;"> <br><br>
